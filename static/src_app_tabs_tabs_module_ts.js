...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'Analytic',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_analytic_analytic_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../analytic/analytic.module */ 5639)).then(m => m.AnalyticPageModule)
            },
            {
                path: 'Setting',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_setting_setting_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../setting/setting.module */ 943)).then(m => m.SettingPageModule)
            },
            {
                path: '',
